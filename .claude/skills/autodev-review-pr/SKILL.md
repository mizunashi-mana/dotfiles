...
2. **Steering ドキュメントの確認**:
   - `.ai-agent/steering/tech.md` で技術スタック・Nix 規約を確認
   - `.ai-agent/structure.md` でディレクトリ構成・モジュール構造を確認
   - `.ai-agent/steering/product.md` で対象環境を確認
...
- セキュリティ脆弱性（シークレット漏洩、不適切なパーミッション）
